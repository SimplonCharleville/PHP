...
if(isset($_POST['fname'], $_POST['name'])){
	...
	// Modification de la valeur d'un cookie (on refait un setcookie() avec le même nom)
	//setcookie('user', 'Nouvelle valeur', time() + 365*24*3600, null, null, false, true);

	// Suppression du cookie (on définit une date d'expiration passée)
